...
app.post('/api/products', verifyToken, async (req, res) => {
    try {
        ...
        const product = Object.assign(Object.assign({}, productData), { vendorId: req.userId, createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp(), active: true, views: 0, likes: 0 });
...
app.put('/api/products/:id', verifyToken, async (req, res) => {
    try {
        ...
        if ((productData === null || productData === void 0 ? void 0 : productData.vendorId) !== req.userId) {
...
app.post('/api/orders', verifyToken, async (req, res) => {
    try {
        ...
        const order = Object.assign(Object.assign({}, orderData), { userId: req.userId, status: 'pending', createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp() });
