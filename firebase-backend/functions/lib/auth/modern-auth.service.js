...
exports.modernAuth = exports.ModernAuthService = void 0;
...
class ModernAuthService {
    constructor() {
        ...
        this.REFRESH_SECRET = process.env.REFRESH_SECRET || crypto.randomBytes(32).toString('hex');
    }
    /**
     * Initialize passwordless authentication
     */
    async initPasswordlessAuth(email, deviceInfo) {
        try {
     ...
     */
    async verifyPasswordlessAuth(challengeId, token) {
        var _a, _b, _c, _d, _e;
        try {
            ...
            const authToken = jwt.sign({
                uid: user.uid,
                email: user.email,
                role: ((_a = user.customClaims) === null || _a === void 0 ? void 0 : _a.role) || 'customer'
            }, this.JWT_SECRET, { expiresIn: '1h' });
            const refreshToken = jwt.sign({ uid: user.uid }, this.REFRESH_SECRET, { expiresIn: '30d' });
            // Store session
            await this.db.collection('sessions').doc(user.uid).set({
                userId: user.uid,
                deviceId: (_b = challenge.deviceInfo) === null || _b === void 0 ? void 0 : _b.deviceId,
                fingerprint: (_c = challenge.deviceInfo) === null || _c === void 0 ? void 0 : _c.fingerprint,
                ipAddress: (_d = challenge.deviceInfo) === null || _d === void 0 ? void 0 : _d.ipAddress,
                userAgent: (_e = challenge.deviceInfo) === null || _e === void 0 ? void 0 : _e.userAgent,
                createdAt: admin.firestore.FieldValue.serverTimestamp(),
     ...
     */
    async socialAuth(provider, idToken) {
        var _a;
        try {
            let decodedToken;
    ...
    async verifyMFA(userId, code) {
        ...
        try {
            ...
            if (!((_a = userData === null || userData === void 0 ? void 0 : userData.mfa) === null || _a === void 0 ? void 0 : _a.enabled)) {
                return false;
            }
...
exports.ModernAuthService = ModernAuthService;
exports.modernAuth = new ModernAuthService();
