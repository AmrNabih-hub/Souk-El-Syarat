        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              {[
                { icon: FacebookIcon, href: 'https://facebook.com/soukel-syarat', label: 'Facebook' },
                { icon: InstagramIcon, href: 'https://instagram.com/soukel-syarat', label: 'Instagram' },
                { icon: TwitterIcon, href: 'https://twitter.com/soukel-syarat', label: 'Twitter' },
                { icon: LinkedInIcon, href: 'https://linkedin.com/company/soukel-syarat', label: 'LinkedIn' },
